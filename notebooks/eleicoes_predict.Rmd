...
```{r}
mod <- lm(votos ~ sequencial_candidato + nome + uf + partido + quantidade_doacoes + quantidade_doadores +
                  total_receita +  media_receita + recursos_de_outros_candidatos.comites +
                  recursos_de_pessoas_fisicas + recursos_de_pessoas_juridicas + recursos_proprios +
                  recursos_de_partido_politico + quantidade_despesas + quantidade_fornecedores +
                  total_despesa + media_despesa + sexo + grau + estado_civil + ocupacao,
          data = training_data)
