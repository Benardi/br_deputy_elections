...
data_scaled_2006 %>% 
  dplyr::sample_frac(.7) -> train_data_2006
...
dplyr::anti_join(data_scaled, 
                 train_data_2006, 
                 by = 'id') -> testing_data_2006

cat("#### Test Data ",
    "\n##### Observations: ",nrow(testing_data_2006),
    "\n##### Variables: ",ncol(testing_data_2006))
```
...
```{r}
mod <- lm(votos ~ quantidade_fornecedores * partido + media_despesa * partido +
...
data_scaled_2010 %>% 
  dplyr::sample_frac(.7) -> train_data_2010
...
dplyr::anti_join(data_scaled_2010, 
                 train_data_2010, 
                 by = 'id') -> testing_data_2010

cat("#### Test Data ",
    "\n##### Observations: ",nrow(testing_data_2010),
    "\n##### Variables: ",ncol(testing_data_2010))
```
