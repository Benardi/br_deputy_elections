...
> On both models different combinations of the predictors **total_receita** and **total_despesa** were clearly the best predictors.
...
Now let’s talk about the results taken from the test data (more meaningful).
